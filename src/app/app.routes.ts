...
import {ProgramAlimentaireComponent} from './components/program-alimentaire/program-alimentaire.component';
...
export const routes: Routes = [
  ...
  {path: 'programmes-alimentaires', component: ProgramAlimentaireComponent},
